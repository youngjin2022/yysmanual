        ...
        <v-col class="" style="padding: 60px 0px;" :cols="this.$vuetify.breakpoint.mobile ? 10 : 8">
            <v-row class="ma-0 pa-0" v-if="this.$vuetify.breakpoint.mobile" no-gutters>
                <v-col class="mb-12" cols="12">
                    <span class="fontSizeImageTitle font-weight-medium suibTitleDL">목욕일정</span>
                </v-col>
                ...
                <v-col class="d-flex justify-center px-2 pb-14" cols="12">
                    <v-card 
                        ...
                        <v-divider class="mx-4"></v-divider>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">① 등록할 수급자를 선택해주세요.</div>
                    </v-card>
                </v-col>
                <v-col class="d-flex justify-center px-2 pb-14" cols="12">
                    <v-card 
                        ...
                        <v-divider class="mx-4"></v-divider>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">① 목욕 하실 시간을 입력 후 저장 버튼을 클릭해주세요.</div>
                    </v-card>
                </v-col>
            </v-row>
