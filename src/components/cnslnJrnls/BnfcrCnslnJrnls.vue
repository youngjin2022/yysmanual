        ...
        <v-col class="" style="padding: 60px 0px;" :cols="this.$vuetify.breakpoint.mobile ? 10 : 8">
            <v-row class="ma-0 pa-0" v-if="this.$vuetify.breakpoint.mobile" no-gutters>
                <v-col class="mb-12" cols="12">
                    <span class="fontSizeImageTitle font-weight-medium suibTitleDL">분기별 상담일지</span>
                </v-col>
                <v-col class="d-flex justify-center px-2 pb-14" cols="12">
                    <v-card 
                        ...
                        <v-divider class="mx-4"></v-divider>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">① 분기별 상담이력을 선택해주세요.</div>
                    </v-card>
                </v-col>
                <v-col class="d-flex justify-center px-2 pb-14" cols="12">
                    <v-card 
                        ...
                        <v-divider class="mx-4"></v-divider>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">① 모든 내용을 기입 후 저장버튼을 클릭해주세요.</div>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">② 급여제공반영 설명은 <a @click="routerAction('ConLogRef')">여기</a>를 클릭해주세요.</div>
                    </v-card>
                </v-col>
            </v-row>
