        ...
        <v-col class="" style="padding: 60px 0px;" :cols="this.$vuetify.breakpoint.mobile ? 10 : 8">
            <v-row class="ma-0 pa-0" v-if="this.$vuetify.breakpoint.mobile" no-gutters>
                <v-col class="mb-12" cols="12">
                    <span class="fontSizeImageTitle font-weight-medium suibTitleDL">계약서 확인사항</span>
                </v-col>
                <v-col class="d-flex justify-center px-2 pb-14" cols="12">
                    <v-card
                        class=""
                        elevation="0" rounded="md" outlined>
                        <div class="mt-7 mb-2 mx-4 fontSizeFdT font-weight-medium">STEP 1 &#41; 계약서 확인사항 추가 및 삭제.</div>
                        ...
                        <v-divider class="mx-4"></v-divider>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">① 작성 버튼을 클릭해주세요.</div>
                    </v-card>
                </v-col>
                <v-col class="d-flex justify-center px-2 pb-14" cols="12">
                    <v-card
                        class=""
                        elevation="0" rounded="md" outlined>
                        <div class="mt-7 mb-2 mx-4 fontSizeFdT font-weight-medium">STEP 2 &#41; 계약서 확인사항 추가 및 삭제1.</div>
                        <v-divider class="mx-4"></v-divider>
                        <div class="mt-4 mb-5 mx-4 fontSizeOne">
                            <v-img alt="pencil" style="border: solid 1px black; height: 100%; width: 100%;" content-class
                                src="../../assets/images/CheckList1.png">
                            </v-img>
                        </div>
                        <v-divider class="mx-4"></v-divider>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">① 확인 내용을 입력하고 파란색 디스크 버튼을 클릭하면 밑으로 항목이 추가됩니다. 제거가 필요한 항목은 회색 쓰레기통 버튼을 클릭해주세요.</div>
                    </v-card>
                </v-col>
            </v-row>
            <v-row class="ma-0 pa-0" v-else no-gutters>
                ...
                <v-col class="d-flex justify-center px-3" cols="12">
                    <v-card
                        ...
                        <div class="mt-2 mb-2 fontSizeOne font-weight-medium">STEP 1 &#41; 계약서 확인사항 추가 및 삭제가 필요시 작성 버튼을 클릭해주세요.</div>
                    </v-card>
                </v-col>
                ...
                <v-col class="d-flex justify-center px-3" cols="12">
                    <v-card
                        ...
                        <div class="mt-2 mb-2 fontSizeOne font-weight-medium">
                            STEP 2 &#41; 확인 내용을 입력하고 파란색 디스크 버튼을 클릭하면 밑으로 항목이 추가됩니다. 제거가 필요한 항목은 회색 쓰레기통 버튼을 클릭해주세요.
                        </div>
                    </v-card>
                </v-col>
                <v-col class="d-flex mb-12" cols="12">
