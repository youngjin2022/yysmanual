<template>
    <v-row class="ma-0 pa-0" no-gutters>
        ...
        <v-col class="" style="padding: 60px 0px;" :cols="this.$vuetify.breakpoint.mobile ? 10 : 8">
            <v-row class="mb-15 pa-0" v-if="this.$vuetify.breakpoint.mobile" no-gutters>
                <v-col class="mb-15" cols="12">
                    <span class="fontSizeImageTitle font-weight-medium suibTitleDL">본인부담금 입금정보</span>
                </v-col>
                <v-col class="d-flex justify-center px-2 pb-15 mb-15" cols="12">
                    <v-card style="margin-bottom: 130px !important;"
                        class="mb-15"
                        elevation="0" rounded="md" outlined>
                        <div class="mt-7 mb-2 mx-4 fontSizeFdT font-weight-medium">STEP 1 &#41; 본인부담금 입금정보 저장 방법.</div>
