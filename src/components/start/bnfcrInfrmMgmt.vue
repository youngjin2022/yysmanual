            ...
            <v-row class="ma-0 pa-0" v-if="this.$vuetify.breakpoint.mobile" no-gutters>
                ...
                <v-col class="d-flex justify-center px-2 pb-14" cols="12">
                    <v-card style="margin-bottom: 260px !important;"
                        ...
                        <div class="mt-7 mb-2 mx-4 fontSizeFdT font-weight-medium">STEP 1 &#41; 수급자 신규 등록하기.</div>
                        ...
                        <v-divider class="mx-4"></v-divider>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">① 신규 버튼 클릭 후 사진을 먼저 등록해주세요.</div>
                        <div class="mt-2 mb-2 mx-4 fontSizeDE">② 수급자 정보와 보호자 정보까지 입력을 마친 후 저장 버튼을 클릭해주세요.</div>
                    </v-card>
                </v-col>
            </v-row>
